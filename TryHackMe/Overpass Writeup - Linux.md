...
![screenshot](../writeup-resources/overpass/nmap1.PNG)
...
![screenshot](../writeup-resources/overpass/nmap2.PNG)

Checking the website, we land on the following page :

![screenshot](../writeup-resources/overpass/web1.PNG)
...
![screenshot](../writeup-resources/overpass/wordlist1.PNG)
...
![screenshot](../writeup-resources/overpass/hydra.PNG)
...
![screenshot](../writeup-resources/overpass/sqlmap1.PNG)
...
![screenshot](../writeup-resources/overpass/sqlmap2.PNG)
...
![screenshot](../writeup-resources/overpass/sources1.PNG)
...
![screenshot](../writeup-resources/overpass/setCookies.PNG)
...
![screenshot](../writeup-resources/overpass/reloadPage.PNG)
...
![screenshot](../writeup-resources/overpass/user3-rot47.PNG)

The decoded file contains a password, we can try using it as james's password with the sudo -l command :

![screenshot](../writeup-resources/overpass/user4-using_found_password.PNG)
...
![screenshot](../writeup-resources/overpass/user5-cron.PNG)
...
![screenshot](../writeup-resources/overpass/user6-navigate-to-path-and-read-file.PNG)
...
![screenshot](../writeup-resources/overpass/user7-try-exploit-date.PNG)
...
![screenshot](../writeup-resources/overpass/user8-write-rights-on-etc-hosts.PNG)

Then, we need to create a local directory on our attacker machine, that will contain the script that is being fetched :

![screenshot](../writeup-resources/overpass/user-8-create-directory-to-fetch-the-exploit.PNG)

Add the payload in the sh script :

![screenshot](../writeup-resources/overpass/user11-modify-payload.PNG)

And we also have to start a server on port 80 to make the file available :

![screenshot](../writeup-resources/overpass/user-9-start-server-port-80.PNG)

The last thing we need to do is replace the IP for overpass.thm with our IP :

![screenshot](../writeup-resources/overpass/user-10-modify-etc-hosts.PNG)
...
![screenshot](../writeup-resources/overpass/user12-see-the-call-on-the-server.PNG)

In the listener, we got a shell as root!

From here we can retrieve the final flag :)

![screenshot](../writeup-resources/overpass/user13-get-root-shell.PNG)