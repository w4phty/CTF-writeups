...
![screenshot](../writeup-resources/road/nmap1.PNG)
...
![screenshot](../writeup-resources/road/nmap2.PNG)
...
![screenshot](../writeup-resources/road/web5.PNG)
...
![screenshot](../writeup-resources/road/burp3-idor.PNG)
...
![screenshot](../writeup-resources/road/burp4.PNG)

We can now try and login to the dashboard as admin, using the password we chose in the reset function :

![screenshot](../writeup-resources/road/web6-after-burp-idor.PNG)
...
![screenshot](../writeup-resources/road/web7-shell-php.PNG)
...
```
<!-- /v2/profile../writeup-resources/road/ -->
```

Navigating to this directory, we get the following message : 

![screenshot](../writeup-resources/road/web9.PNG)

So we can try navigating to /v2/profile../writeup-resources/road/shell.php, and we get a shell!


![screenshot](../writeup-resources/road/shell1.PNG)
...
![screenshot](../writeup-resources/road/shell2.PNG)

Then we can use automated enumeration tools like LinEnum to get more information: 

![screenshot](../writeup-resources/road/privesc1.PNG)
...
![screenshot](../writeup-resources/road/privesc2.PNG)
...
![screenshot](../writeup-resources/road/privesc4.PNG)

From here we can retrieve databases, tables and their content : 

![screenshot](../writeup-resources/road/privesc5.PNG)
...
![screenshot](../writeup-resources/road/privesc6.PNG)
...
![screenshot](../writeup-resources/road/privesc8.PNG)
...
![screenshot](../writeup-resources/road/privesc9.PNG)

The last thing we need to do is running sudo loading the shared librarie we created :

![screenshot](../writeup-resources/road/privesc10.PNG)
